...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-03-2024 a las 01:37:36
...
CREATE TABLE `cliente` (
  ...
  `tipo_documento` enum('cc','ce','nit','tut') DEFAULT NULL,
  ...
  `estado_civil` enum('soltero','casado','divorciado','union libre','xiude') DEFAULT NULL,
...
CREATE TABLE `contratista` (
  ...
  `nombrel` varchar(25) NOT NULL,
  `nombre2` varchar(25) NOT NULL,
  `apellidol` varchar(25) NOT NULL,
  `apellido2` varchar(25) NOT NULL,
  `tipo_documento` enum('cc','ce','nit','tut') DEFAULT NULL,
  `no_documento` varchar(25) NOT NULL,
  `sexo` enum('masculino','femenino') DEFAULT NULL,
